...
private:
	Animation animation_sun_text;    //ex特效
	bool is_sun_text_visible = false;//ex特效是否可见

private:
	const float speed_sun_ex = 0.15f;  //大招日光炸弹下落速度
	const Vector2 velocity_sun = { 0.25f,-0.5f };//小日光炸弹初始速度
